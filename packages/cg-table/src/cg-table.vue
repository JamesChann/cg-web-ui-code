      ...
      _pipe_name_arr.forEach((_v, _i) => {
        if (_v[Object.keys(_v)[0]].indexOf('date|') != -1) {
          ...
          this._data_list.forEach((_e, _j) => {
            _e[Object.keys(_v)[0] + '$id'] = _e[Object.keys(_v)[0]]
            _e[Object.keys(_v)[0]] = this.$mapState[_v[Object.keys(_v)[0]]][_e[Object.keys(_v)[0]]]
          })
        }
      })
    },
...
<style lang="scss" scoped src="./cg-table.scss"></style>